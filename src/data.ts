...
export const portfolioData = {
    ...
    title: "An HR Manager turned Frontend Developer with 8+ years of experience in talent acquisition, now building stunning and user-friendly web applications.",
  ...
  I’m continually learning and refining my skills in modern frontend technologies, and I focus on creating projects that deliver real impact.`,
    ...
    contactInfo: { // This is the single, correct contactInfo object
    ...
    projects: [
      {
        title: "neura-talk",
        description: "A sleek AI-powered chat app built with React Native and OpenAI’s GPT, offering a natural conversational experience.",
      ...
      },
      {
        ...
        description: "A restaurant reservation and menu UI based on Meta’s capstone project. Customized and extended.",
      ...
      },
      {
        ...
        description: "A playful image gallery app where clicking reveals random animal images.",
      ...
      {
        title: "currex",
        description: "A clean currency converter app powered by ExchangeRate API.",
        githubUrl: "https://github.com/codebysamuel/currex",
        technologies: ["HTML", "CSS", "JavaScript", "ExchangeRate API", "Flags API"],
